...
ServerLua = "data/lua/level_classic_server.lua"
ReleaseLevel = 1
...
Modules =
{
	...
	{ Position = CVector(-0.1, -15.3, 1), Scale = CVector(1, 1, 1), Rotation = CAngleAxis(1,0,0,0),	Lua = "snow_target_50", Shape="snow_target_50", Score = 50, Friction = 25 },
	{ Position = CVector(-0.1, -15.35, 2.55), Scale = CVector(1, 1, 1), Rotation = CAngleAxis(1,0,0,0), Lua = "snow_target_100", Shape="snow_target_100", Score = 100, Friction = 10 },
	{ Position = CVector(-0.1, -15.33, 2.8), Scale = CVector(1, 1, 1), Rotation = CAngleAxis(1,0,0,0), Lua = "snow_target_300", Shape="snow_target_300", Score = 300, Friction = 10 },
