...
Author = "Ace"
ServerLua = "data/lua/level_classic_flat_server.lua"
ReleaseLevel = 1
...
Modules =
{
	...
	{ Position = CVector(-0.1, -15.3, 1), Scale = CVector(1, 1, 1), Rotation = CAngleAxis(1,0,0,0),	Lua = "snow_target_50_flat", Shape="snow_target_50_flat", Score = 50, Friction = 15 },
