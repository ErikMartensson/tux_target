...
Modules =
{
	...
	{ Position = CVector(-0.1, -15.5, 1), Scale = CVector(1, 1, 1), Rotation = CAngleAxis(1,0,0,0), Lua = "snow_target_50_flat", Shape="snow_target_50_flat", Score = 50, Friction = 30 },
	{ Position = CVector(-0.1, -15, 2.4), Scale = CVector(1, 1, 1), Rotation = CAngleAxis(1,0,0,0), Lua = "snow_target_100_flat", Shape="snow_target_100_flat", Score = 100, Friction = 40 },
	{ Position = CVector(-0.1, -14.80, 2.45), Scale = CVector(1, 1, 1), Rotation = CAngleAxis(1,0,0,0), Lua = "snow_target_300_flat", Shape="snow_target_300_flat", Score = 300, Friction = 50 }
}
